...
const { getUserByEmail } = require('../../queries/homeowner/auth');
const { updateHomeownerAccount } = require('../../queries/homeowner/account');
            ...
            if (flag) {
                try {
                    ...
                    if (flag) {
                        ...
                        let respUpdateHomeOwner = await runPreparedQuery(updateHomeownerAccount, 
                            { 
                                Firstname,
                                Middlename,
                                Lastname,
                        ...
                        if (respUpdateHomeOwner.rowsAffected > 0) {
